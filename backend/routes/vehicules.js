...
// Route pour delete les vehicules et les véhicules associées à une intervention
router.delete('/delete/:plaque', (req,res)=>{
    Vehicule.findOneAndDelete({plaque:req.params.plaque})
    .then(vehiculeData=>{
        Intervention.updateMany({vehicule: vehiculeData._id}, {$set:{vehicule: null,etat:'finie'}})
        .then(interVehicule=>{
